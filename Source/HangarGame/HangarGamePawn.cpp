...
const FName AHangarGamePawn::FireForwardBinding("FireForward");
const FName AHangarGamePawn::FireRightBinding("FireRight");
...
void AHangarGamePawn::FireShot(FVector FireDirection)
{
...
void AHangarGamePawn::ShotTimerExpired()
{
	bCanFire = true;
}
